...
**Stage 3. The members sign the treaty** at [warondisease.org](https://warondisease.org). Every signature is one more data point in a pressure system pointed at 193 heads of state. The nonprofit does not need to do anything to cause this step; the member activation email does it automatically by linking.
