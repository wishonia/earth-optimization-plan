...
Target: **{{< var global_coordination_target_pct >}} global participation** ({{< var global_registered_voters_nounit >}}+ verified votes). That is the canonical public coordination target in the prize model. The old Chenoweth-style {{< var global_population_activism_threshold_pct >}} threshold is useful as a historical lower bound for when movements become hard to ignore, not as the end-state goal here.
