...
**The activation threshold.** {{< var global_population_activism_threshold_pct >}} of global population actively supporting ({{< var three_point_five_percent_of_global_population_nounit >}} verified voters). Every movement that has hit this threshold in the last century has succeeded. Zero exceptions {{< var global_population_activism_threshold_pct_cite >}}.
