...
drivers = ['BULLET_COST_556_NATO', 'GLOBAL_POPULATION_2024']
driver_labels = ['Cost per 5.56mm NATO Round (Bulk)', 'Global Population in 2024']
impacts_low = [510.0, 21.794871794871824]
impacts_high = [-283.33333333333326, -20.731707317073187]
...
units_label = "rounds/person/year"
if units_label:
...
output_path = get_figure_output_path('tornado-bullets_per_person_annual.png')
