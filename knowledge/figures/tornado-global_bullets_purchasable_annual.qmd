...
drivers = ['BULLET_COST_556_NATO']
driver_labels = ['Cost per 5.56mm NATO Round (Bulk)']
impacts_low = [4080000000000.0]
impacts_high = [-2266666666666.666]
...
output_path = get_figure_output_path('tornado-global_bullets_purchasable_annual.png')
