...
drivers = ['GLOBAL_COORDINATION_ACTIVATION_REWARD_PER_VERIFIED_PARTICIPANT', 'GLOBAL_COORDINATION_VERIFICATION_AND_PAYMENT_COST_PER_PARTICIPANT', 'GLOBAL_COORDINATION_PLATFORM_AND_OPERATIONS_COST']
driver_labels = ['Activation Reward per Verified Participant', 'Verification and Payment Cost per Participant', 'Global Coordination Platform and Operations Cost']
impacts_low = [-12384427485.0, -2064071247.5, -2000000000.0]
impacts_high = [20640712475.0, 6192213742.5, 4000000000.0]
